...
const FINAL_CTA_HEADING_CLASS =
  "text-center text-2xl font-normal uppercase leading-[1.08] tracking-[0.06em] text-foreground max-sm:text-xl max-sm:leading-[1.1] sm:text-3xl md:text-4xl lg:text-[2.75rem]";
...
const CTA_BEAMS_BAND =
  "min-h-[600px] max-md:min-h-[min(68vh,480px)] md:min-h-[min(85vh,920px)]";
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className={`relative z-10 flex w-full ${CTA_BEAMS_BAND} flex-col justify-center px-4 py-12 max-md:px-3 max-md:py-9 sm:px-6 sm:py-16 lg:px-8`}
        >
          <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-8 max-md:gap-6 sm:gap-10">
